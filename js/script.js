...
var quizQuestions = [
  {
    title: "What does the typeof operator return for an undefined variable:",
    options: ["undefined", "null", "string", "number"],
    answer: 1,
  },
  {
    title: "Which of the following is not a valid way to declare a variable in JavaScript:",
    options: ["var myVar = 42", "const myVar = 42", "let myVar = 42", "myVar = 42"],
    answer: 4,
  },
  {
    title:"What will the code 'console.log(2 +\"2\");' output?",
    options: ["4", "2","\"22\"","NaN"],
    answer:2,
  },
  {
    title:'Which of the following statements correctly compares two values for both value and type equality in JavaScript:',
    options:[ 'x == y',' x === y', ' x = y',' x != y'],
    answer: 4,
  },
  {
    title:'How can you include an external JavaScript file in an HTML document:',
    options: ['Using the <js> element',' Using the <link> element', ' Using the <script> element',' Using the <script> element'],
    answer:1,
  }
];
